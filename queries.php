...
<head>
    <title>Gurugedara Student Queries</title>
...
<div class="testbox">
    <form action="/">
        <div class="banner">
            <h1>Gurugedara Educational TV Channels</h1>
            <br>

        </div>

        <div>
            <h2>Eye Channel/ Nethra Channel Educational Telecast</h2>
        </div>
        <div>
        ...
        <div class="item">
            <p>Queries<span class="required"></span></p>
